                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-sm font-medium">
                            ...
                            <li><Link href="/destinations" className="hover:text-[#667EEA] transition">DESTINATIONS</Link></li>
                            <li><Link href="/join" className="hover:text-[#667EEA] transition">MEMBERSHIPS</Link></li>
                            <li><Link href="/blog" className="hover:text-[#667EEA] transition">BLOG</Link></li>
                        </ul>
                    </div>
